          ...
          <tr>
            ...
            <?php if ($this->session->userdata('status') == 'login') { ?>
              <td>
                ...
                <a href="<?= base_url() ?>publication/delete/<?= $p['id'] ?>" class="badge badge-danger" onclick="return confirm('Apakah anda yakin ingin menghapus publikasi ini?')"><i class="far fa-trash-alt"></i></a>
              </td>
            <?php } ?>
          </tr>
        <?php } ?>
